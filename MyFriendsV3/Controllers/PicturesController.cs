...
namespace MyFriendsV3.Controllers
{
    public class PicturesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,PictureName,PictureFile")] Picture picture)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PictureName,PictureFile")] Picture picture)
        {
            if (id != picture.Id)
            {
                return NotFound();
